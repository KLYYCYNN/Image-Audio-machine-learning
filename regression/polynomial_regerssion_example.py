...
def polynomial_regression(x, y, order, alpha, n):
    ...
    #w, b = scale_params(X_unscaled, w_init, b_init, 'scale')
    cost = []
...
x, y = training_set_gen(func4, 8, 12 , 100)
plt.plot(x, y, 'b.')
plt.plot(x, func4(x), 'k-')
plt.xlabel('$x$')
plt.ylabel('$y$')
...
order = 5
learning_rate, n_iteration = 1e-2, 100000
